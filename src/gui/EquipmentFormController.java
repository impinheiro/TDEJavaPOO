...
public class EquipmentFormController implements Initializable {
	...
	private Equipment getFormData() throws ParseException {
	    ...
	    obj.setIsAvailable(checkBoxAvailable.isSelected());
	...
	public void updateFormData() {
	    ...
	    checkBoxAvailable.setSelected(entity.getIsAvailable() == null ? true : entity.getIsAvailable());  // Define o valor padrão como true
	    ...
	    if (entity.getId() == null) {  // Novo equipamento
	        ...
	        checkBoxAvailable.setSelected(true); // Garante que a checkbox seja marcada para novos equipamentos
	        checkBoxAvailable.setDisable(true);
